...
<div class="form-row">
    ...
    <div class="form-group col-md-4">
        ...
        <input type="text" name="patient[lastname]" class="form-control @error('patient.lastname') is-invalid @enderror" value="{{ $patient->last_name ?? old('patient.lastname') }}" required>
...
<div data-bind="foreach: addresses.slice(0,6)">
    <div class="form-row">
        ...
        <div class="form-group col-md-1" data-bind="visible: $parent.addresses().length > {{max(count($patient->addresses ?? []), 1)}}">
...
<div id="display" data-bind="foreach: phones.slice(0,6)">
    <div class="form-row">
        ...
        <div class="form-group col-md-1" data-bind="visible: $parent.phones().length > {{max(count($patient->contacts ?? []), 1)}}">
